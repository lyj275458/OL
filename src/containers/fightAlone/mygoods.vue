		...
		<div class=" goods-detail" v-for="item in curObj">
			<div class="top">
				<p>
					...
					<span class="right" v-show="item.isSuccess==2">拼团失败</span>
					<span class="right" v-show="item.isSuccess==0">待拼团</span>
					<span class="right" v-show="item.isSuccess==1">拼团成功</span>
				</p>
			</div>
			<div class="goods-name">
				<div class="food" @click="getDetail(item.togetherRecordId,getMemberId)">
					<p class="fodImg">
			...
			<div class="bot">
				<div v-show="item.isSuccess==1" class="detail" @click="getDetail(item.togetherRecordId,getMemberId)">订单详情</div>
				<div v-show="item.isSuccess!=2" class="fried" @click="getFriend(item.togetherRecordId,getMemberId)">邀请好友拼团</div>
				<div v-show="item.isSuccess==2" class="fried" @click="goDetail(item.productId)">重新拼团</div>
	...
	export default {
		...
		methods:{
			...
			getListBack(data){
				...
				//this.shareData.url="http://ol-site.olquan.com/weixin/auth?recId="+this.$route.query.memberId+"&view="+encodeURIComponent(CUR_URLBACK+'fightAlone/mygoods');
				this.shareData.url="http://test-mobile.olquan.cn/weixin/auth?recId="+this.$route.query.memberId+"&view="+encodeURIComponent(CUR_URLBACK+'fightAlone/mygoods');
				//console.log(data)
