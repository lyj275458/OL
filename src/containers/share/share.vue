<template>
	<div class="partake" v-bind:class="{ 'spe': showHeigth===true}">
		<div class="goodsdetail" @click="goGood(curObj.productId)">
			<div class="goods-l">
		...
		<div class="name">
			<ul class="name-list">
				...
				<li v-show="curObj.isSuccess!=1"><img :src="quesImg"/></li>
			</ul>
...
//				}
			...
			goBuything(){
				...
				let data={
					...
					memberId:this.$route.query.memberId,
					togetherId:this.$route.query.togetherId,
					togetherRecordId:this.$route.query.id
				}
				console.log(data)
				window.location.href=API_HOST+'ol/confirmOrder1.html?num='+this.num+'&'+'normalId='+this.normalId+'&'+'memberId='+this.$route.query.memberId+'&'+'togetherId='+this.curObj.togetherId +'&'+'togetherRecordId='+this.$route.query.id
